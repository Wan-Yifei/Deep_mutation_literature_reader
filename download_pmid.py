...
def liter_status_check(pmids_doi, literature_folder):
    ...
    :param pmids_doi: key - pmid, value - download status;
...
def get_pdf_url(doi, attempts_limit=3, sleep_between_tries=60):
    ...
    :param attempts_limit: try times limit;
    :param doi: DOI of literatures;
    :param sleep_between_tries: sleep times bwtween get PDF URL attempts;
    :return: pdf url.
    """
...
def down_literature(pmids_doi, pmid_checkdict, literature_folder, attempts_limit=3, sleep_between_get_url=10,
    ...
    :param sleep_between_tries: sleep times bwtween download PDF URL attempts;
    :return: None.
    """
